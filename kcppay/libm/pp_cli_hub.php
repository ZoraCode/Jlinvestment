...
<?
	...
	$memo			= $_POST[ "memo"   ];			// 메모
    $friend_count   = $_POST[ "friend_count"   ];	// 인원수
    $cost   = $_POST[ "cost"   ];				// 원가
    $idx   = $_POST[ "idx"   ];				// 원가
    $category   = $_POST[ "category"   ];				// 원가
    $pay_method   = $_POST[ "pay_method"   ];				// 원가

	if($use_pay_method=="100000000000"){$pay_method = "CARD";}
	if($use_pay_method=="010000000000"){$pay_method = "BANK";}
	if($use_pay_method=="001000000000"){$pay_method = "VBANK";}
...
?>
    ...
    <form name="pay_info" method="post" action="/m/pay_proc">
		...
		<input type="hidden" name="via"				value="m">

		<input type="hidden" name="category"		value="<?=$category   ?>">
        <input type="hidden" name="idx"				value="<?=$idx   ?>">
        <input type="hidden" name="memo"			value="<?=$memo   ?>">
        <input type="hidden" name="friend_count"	value="<?=$friend_count   ?>">
    </form>
    </body>
    </html>
