					...
					<div class="pop_story">
						<div>
							<a href="https://jlinvestment.co.kr/vipapply">
								<img src="../../images/main/springPop.png" alt="">
							</a>	
							<!-- <img src="../../images/main/fishing.png" alt=""> -->
						</div>
					</div>
        </div>
        <div class="btn_wrap">
	...
	<div class="swiper mn_three">
		...
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide">
				<div class="sld-img">
					<video class="ima" src="/images/main/main_vdo.mp4" preload="auto" muted autoplay loop></video>
				</div>

				<div class="title">
					<h2 class="indi">"JL 투자그룹" 필란트로피 클럽 가입 <br>
					후원을 넘어, 가치를 실현?</h2>
					<div class="line indi"></div>
					<h3 class="indi">기아대책 후원자 리딩그룹, 1억원 이상을 기부, 약정한 후원자 기업</h3>
				</div>
			</div>
			...
			<div class="swiper-slide">
				...
				<div class="title">
					<h2>제이엘투자그룹 <span class="red">사칭</span> 안내</h2>
					<div class="line"></div>
					<h3>최근 제이엘투자그룹을 <span class="red">사칭</span>하여 해외선물 대여계좌 알선, 코인 권유 등의 행위를 포착하였습니다. <br>
					 현재 수천만원의 <span class="red">피해액</span>이 확인 되었고, 저희 제이엘투자그룹은 해외선물 대여계좌 알선과 코인 권유 등을 하지 않습니다. <br>
					 각별히 주의해주시기 바라며 공지사항을 꼭 <span class="red">필독</span>해주시기 바랍니다.</h3>
				</div>
			</div>
...
<section class="thr container">

	<div class="title">
		<h2>제이엘투자그룹은 <br>세가지 <span class="color">핵심 가치</span>를 추구합니다.</h2>
	</div>

	<div class="thr_img">
		<img class="img" src="../../images/main/three_tab.png" alt="선한 영향력, 성장 환경, 자산">
	</div>
	...
	<div class="swiper tube container">
		...
		<ul class="swiper-wrapper tube_list">
			...
			<li class="swiper-slide">
				<div class="but_img t_a">
					<a href="https://www.youtube.com/@JLINVESTMENT" target="_blank">보러 가기</a>
				</div>
			</li>

			<li class="swiper-slide">
				<div class="but_img t_b">
					<a href="https://www.youtube.com/@JLINVESTMENT" target="_blank">보러 가기</a>
				</div>
			</li>
			
			<li class="swiper-slide">
				<div class="but_img t_c">
					<a href="https://www.youtube.com/@JLINVESTMENT" target="_blank">보러 가기</a>
				</div>
			</li>
			
			<li class="swiper-slide">
				<div class="but_img t_d">
					<a href="https://www.youtube.com/@JLINVESTMENT" target="_blank">보러 가기</a>
				</div>
			</li>

			<li class="swiper-slide">
				<div class="but_img t_e">
					<a href="https://jlinvestment.co.kr/h2o" target="_blank">보러 가기</a>
				</div>
			</li>

			<li class="swiper-slide">
				<div class="but_img t_f">
					<a href="https://jlinvestment.co.kr/h2o" target="_blank">보러 가기</a>
				</div>
			</li>

			<li class="swiper-slide">
				<div class="but_img t_g">
					<a href="https://jlinvestment.co.kr/h2o" target="_blank">보러 가기</a>
				</div>
			</li>

			<li class="swiper-slide">
				<div class="but_img t_h">
					<a href="https://jlinvestment.co.kr/h2o" target="_blank">보러 가기</a>
				</div>
			</li>
		
			<li class="swiper-slide">
				<div class="but_img t_i">
					<a href="https://jlinvestment.co.kr/notice" target="_blank">보러 가기</a>
				</div>
			</li>
			
			<li class="swiper-slide">
				<div class="but_img t_j">
					<a href="https://jlinvestment.co.kr/notice" target="_blank">보러 가기</a>
				</div>
			</li>

			<li class="swiper-slide">
				<div class="but_img t_k">
					<a href="https://jlinvestment.co.kr/notice" target="_blank">보러 가기</a>
				</div>
			</li>

			<li class="swiper-slide">
				<div class="but_img t_l">
					<a href="https://jlinvestment.co.kr/notice" target="_blank">보러 가기</a>
				</div>
			</li>
		</ul>
