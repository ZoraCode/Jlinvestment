...
p.fontsize28{font-size: 28px; margin-top: 15px;}
...
.join_layer h1.tit1{font-size: 40px;font-weight: bold;letter-spacing: -2px;margin-bottom: 20px;}
.join_layer p.tit2{font-size: 32px;letter-spacing: -2px;margin-bottom: 10px;}
.join_layer #agree,
.join_layer #agree3{width: 20px;height: 20px;}
.btn_comm {width: 230px; height: 80px; font-size: 32px;}
...
.footer	p {
	...
	.pp_tab li{width: 33.3%;float: left;border:1px solid #c9c9c9;padding: 20px 0;text-align: center;font-size: 23px;box-sizing:border-box;cursor: pointer;}
		...
		<div class="join_layer">
			...
			<?if($step==""){?>
				<form action="" name="joinFrm" id="joinFrm" method="post">
					...
					<img src="/images/mobile/signup/join_nav_01.png"  class="mt80 mb80" alt="">
					<ul class="pp_tab">
					...
					<div class="btn_layer text-center pb70 mt20">
						<a href="/"><button class="btn_comm2 mt30 btn_cancle" type="button" >이전</button></a>
						<button class="btn_comm mt30" type="button" id="btn_apply" >다음</button>
					</div>
				</form>
			<?}elseif($step=="1"){?>
				<form action="" name="joinFrm" id="joinFrm" method="post">
					...
					<img src="/images/mobile/signup/join_nav_02.png"  class="mt80 mb80" alt="">
					<p class="tit2 mb50">회원가입에 필요한 아래 항목들을 작성하시기 바랍니다.</p>
					...
					<div class="ml20 mb50">
						...
						<input type="text" class="input_txt w500px" name="id" id="id" placeholder="아이디" value="" data-valid="notnull" data-alert="아이디" maxlength="12" required>
						<button type="button" class="btn_comm2" id="btn_check_id">중복확인</button>
					</div>
					<div class="ml20 mb50">
						<label for="nick" class="pb20">닉네임</label>
						<input type="text" class="input_txt w500px" name="nick" id="nick" placeholder="닉네임" value="" data-valid="notnull" data-alert="닉네임" required>
						<button type="button" class="btn_comm2" id="btn_check_nick">중복확인</button>
					</div>
					<div class="ml20 mb50">
						<label for="pwd" class="pb20">비밀번호</label>
						<input type="password" class="input_txt w760px" name="pwd" id="pwd" placeholder="비밀번호" value="" data-valid="notnull" data-alert="비밀번호" required>
						<p class="text-muted fontsize28">※ 비밀번호는 4자리 이상으로 입력해주세요.</p>
					</div>
					<div class="ml20 mb50">
						<label for="pwd2" class="pb20">비밀번호 확인</label>
						<input type="password" class="input_txt w760px" name="pwd2" id="pwd2" placeholder="비밀번호확인" value="" data-valid="notnull" data-alert="비밀번호확인" required>
						<p class="text-muted fontsize28">※ 설정하신 비밀번호를 한번 더 입력해주세요.</p>
					</div>
					<div class="ml20 mb50">
						<label for="email1" class="pb20">이메일</label>
						...
						<div class="agree_layer mt50">
							<label for="mail_agree" class="pb35">이메일 수신동의</label>
					...
					<div class="ml20 mb50">
						...
						<div class="telAuth mt10 hid">
							<input type="text" class="input_txt w500px" name="authNo" id="authNo" placeholder="" value="" data-valid="notnull" data-alert="인증번호" >
