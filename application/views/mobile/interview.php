...
.interview_layer li{width:240px;height:335px;float:left;border:1px solid #ccc;margin-right:20px;margin-bottom: 20px;cursor:pointer;box-sizing:border-box;}
.interview_layer li:nth-child(3n){margin-right:0;}
.interview_layer li .img_layer{width:240px;height:191px;overflow:hidden;position:relative;background-color:#d4d4d4;}
...
.interview_layer li .review_contents_layer .review_contents img{width: 760px;}
</style>
	<?if($mode == "write"){?>
