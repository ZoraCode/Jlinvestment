...
.tbl_board tr td .subject{white-space:pre-wrap !important; word-wrap: normal;overflow: hidden; text-overflow: ellipsis;}
.tbl_board tr td{border-right: 0; vertical-align: middle;}
.tbl_board tr td:nth-child(1){padding: 10px 0 !important;}
.tbl_board tr td:nth-child(2){height: 30px;padding-left: 50px; max-width: 345px; white-space:nowrap; word-wrap: normal;overflow: hidden; text-overflow: ellipsis;}
...
.tbl_board tr td .subject{white-space: nowrap;word-wrap: normal;overflow: hidden;text-overflow: ellipsis;}
.review_contents_layer p.name{font-weight: 600;}
/* .review_contents_layer p.title{font-weight: 400;white-space: nowrap; word-wrap: normal;overflow: hidden;width: 780px;text-overflow: ellipsis;} */
.review_contents_layer .review_contents{display: inline-block; width: 100%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; white-space: normal;line-height: 1.6;height: 6.6em;}
...
<style>
.review_contents img{max-width: 760px;}
</style>
