<style>
		...
		<div class="inner board_wrap">
			<?if($t2 == "투자성과"){?>
				<img src="/images/mobile/contents/board/performance.png" class="main_contents_01" alt="">
		...
		<?}else{?>
			<table class="tbl_board tbl_view " cellspacing="0" cellpadding="0" border="0" width="100%">
				...
				<tr class="thead">
					<th>제목</th>
					<td class="board_over_text"><?=$lists[0]['subject']?></td>
				</tr>
				<tr class="thead">
					<th>등록일</th>
