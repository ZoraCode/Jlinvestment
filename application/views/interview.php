...
.interview_layer{width: 100%;display: inline-block;}
.interview_layer li{float:left;width: 273px;border: 1px solid #ccc;height: 368px;margin-right: 20px;margin-bottom: 20px;cursor: pointer;}
.interview_layer li:nth-child(4n){margin-right: 0;}
.interview_layer li .img_layer{width: 273px;height: 224px;overflow:hidden;position: relative;background-color: #d4d4d4;}
.interview_layer li .img_layer img{width: 100%;position: absolute;left: 0;right: 0;top:0;bottom:0;margin: auto;}
.interview_layer li .review_contents_layer{padding: 12px;height: 144px;box-sizing: border-box;}
.interview_layer li .review_contents_layer p.title{font-weight: 600;border-bottom: 1px solid #ccc;padding-bottom: 0;display: inline-block;width: 100%;overflow: hidden;text-overflow: ellipsis;white-space: normal;line-height: 23px;height: 3em;}
.interview_layer li .review_contents_layer p.name{margin-top: 12px;margin-bottom: 12px;}
.interview_layer li .review_contents_layer .review_contents{display: inline-block; width: 100%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; white-space: normal; line-height: 1.2; height: 4.6em;}
</style>
	...
	<?}else{?>
		<div class="interview_layer mb100">
...
<style>
.interview_contents td{text-align: inherit !important;}
.interview_contents p img{max-width: 100%;}
</style>
					<tr class="interview_contents">
						<td colspan="2" style="padding-bottom:50px !important;">
							<?if($lists[0]['etc1'] <> ""){ ?>
                                <?if(strpos($lists[0]['etc1'],"https://") === false){ ?>
                                    <!-- <img src="/upload/board/<?=$pn?>/<?=$lists[0]['upfile']?>" class="m0a mb30" style="max-width: 1024px;" alt=""> -->
									<iframe class="m0a mb30" width="1100" height="600" src="<?=$lists[0]['etc1']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                <?}else{?>
                                    <!-- <img src="<?=$lists[0]['upfile']?>" class="m0a mb30" style="max-width: 1024px;" alt=""> -->
									<iframe class="m0a mb30" width="1100" height="600" src="<?=$lists[0]['etc1']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                <?}?>
							<?}?>
							<?=str_replace("\r\n","<br>",$lists[0]['contents'])?>
