...
.profit_layer li{float:left;width: 273px;border: 1px solid #ccc;height: 368px;margin-right: 20px;margin-bottom: 20px;cursor: pointer;border-radius: 5px;}
.profit_layer li:nth-child(4n){margin-right: 0;}
.profit_layer li .img_layer{width: 273px;height: 224px;overflow:hidden;position: relative;background-color: #d4d4d4;}
				...
				<ul class="profit_layer mt40">
					...
					<li onclick="javascript:location.href='/<?=$pn?>/<?=$page?>/<?=$var["idx"]?>'">
						...
						<div class="review_contents_layer ">
                            ...
                            <p class="title <?if(!empty($idx) and $idx==$var["idx"]){echo "cred";}?>"><?=nl2br(unescape_web_txt($var["subject"]))?></p>
