...
.tbl_board tr td:nth-child(2){text-align: left; padding-left: 30px;}
...
/* .tbl_board tr {border: 0px;} */
/* .tbl_view tr.lst td {border: 0px;}
.tbl_view tr {border: 0px;} */

.payvideo_layer{width: 100%;display: inline-block;}
/* .payvideo_layer li{float:left;width: 273px;border: 1px solid #ccc;height: 333px;margin-right: 20px;margin-bottom: 20px;cursor: pointer;} */
.payvideo_layer li{float:left;width: 273px;outline: 1px solid #ccc;height: 333px;margin-right: 20px;margin-bottom: 20px;cursor: pointer;}
.payvideo_layer li:nth-child(4n){margin-right: 0;}
.payvideo_layer li .img_layer{width: 273px;height: 224px;overflow:hidden;position: relative;background-color: #d4d4d4;}
.payvideo_layer li .img_layer img{width: 100%;position: absolute;left: 0;right: 0;top:0;bottom:0;margin: auto;}
.payvideo_layer li .review_contents_layer{padding: 12px;height: 109px;box-sizing: border-box;}
.payvideo_layer li .review_contents_layer p.title{font-weight: 600;border-bottom: 1px solid #ccc;padding-bottom: 0;display: inline-block;width: 100%;overflow: hidden;text-overflow: ellipsis;white-space: normal;line-height: 23px;height: 2em;}
...
.btn_comm {background-color:#444444;}
</style>
				...
				<td colspan="2" style="padding-bottom:50px !important;">
					<?if($lists[0]['etc1'] <> ""){ ?>
                        <?if(strpos($lists[0]['etc1'],"https://") === false){ ?>
							...
							<iframe class="m0a mb30" width="1200" height="600" src="<?=$lists[0]['etc1']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <?}else{?>
