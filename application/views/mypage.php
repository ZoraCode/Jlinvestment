...
.tbl_view tr.thead th {  background-color: #fff !important;}
.tbl_board tr.thead { background-color: #f2f2f2; text-align: center;}
				...
				<form action="" name="modFrm" id="modFrm" method="post">
					...
					<table class="tbl_board tbl_view " cellspacing="0" cellpadding="0" border="0" width="100%">
						...
						<tr class="thead">
							<th>닉네임</th>
							<td>
								<input type="text" class="input_txt w77p" name="nick" id="nick" placeholder="닉네임" value="<?=$mypage["mb_nick"]?>" data-valid="notnull" data-alert="닉네임" required>
								<button type="button" class="btn_comm" id="btn_check_nick">중복확인</button>
							</td>
						</tr>
						<tr class="thead">
							<th>비밀번호</th>
							<td>
								<input type="password" class="input_txt w50p mb10" name="pwd" id="pwd" placeholder="비밀번호" data-valid="notnull" data-alert="비밀번호" >
						...
						<tr class="thead">
							<th>비밀번호확인</th>
							<td>
								<input type="password" class="input_txt w50p mb10" name="pwd2" id="pwd2" placeholder="비밀번호확인" data-valid="notnull" data-alert="비밀번호확인" >
						...
						<tr class="thead">
							...
							//	if(isset($emailArr)){
								...
								?>
								<input type="text" class="input_txt w100px" name="email1" id="email1" placeholder="" value="<?=$emailArr[0]?>"> @
								<input type="text" class="input_txt w150px" name="email2" id="email2" placeholder="" value="<?=$emailArr[1]?>">
						...
						<tr class="thead">
							...
							<td>
								...
								?>
								<input type="text" class="input_txt w100px" name="hp1" id="hp1" placeholder="" value="<?=$hp1?>" data-valid="notnull" data-alert="전화번호" required maxlength="4"> -
								<input type="text" class="input_txt w100px" name="hp2" id="hp2" placeholder="" value="<?=$hp2?>" data-valid="notnull" data-alert="전화번호" required maxlength="4"> -
								<input type="text" class="input_txt w100px" name="hp3" id="hp3" placeholder="" value="<?=$hp3?>" data-valid="notnull" data-alert="전화번호" required maxlength="4">
								<button type="button" class="btn_comm" id="sendConfirm">인증번호 전송</button>
								<div class="telAuth mt10 hid">
									<input type="text" class="input_txt" style="width:336px !important" name="authNo" id="authNo" placeholder="" value="" >
